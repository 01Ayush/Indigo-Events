...
<head>
    ...
    <style>
        ...
        #reviews {
    padding: 6vw 4vw;
    background: linear-gradient(-90deg, rgba(8, 32, 50, 0.8), rgba(8, 32, 50, 0.8)), url(images/Business.jpg), #082032;
...
<body>
    <div class="wrapper">
        <nav>
            ...
            <div>
                ...
                <label for="show-Sigin-form" class="user-icon search-user" data-target="#mymodal" data-toggle="modal"><i class="fas fa-user" style="font-size:18px">☻</i></label>
            </div>
    ...
    if ($_POST['LOGINE']) {
        ...
        if ($total == 1) {
            ...
            echo "<script>alert('Login succecfully')</script>";
    ?>
    ...
    if ($_POST['LOGIN']) {
        ...
        if (!$email_checked > 0) {
            ...
            if ($PASSWORD == $CPASSWORD) {
                ...
                $user_query = "INSERT INTO admin(NAME,EMAIL,PASSWORD,CPASSWORD) VALUES('$NAME','$EMAIL','$PASSWORD','$CPASSWORD')";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xl-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span>ayush1432joshi@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>
